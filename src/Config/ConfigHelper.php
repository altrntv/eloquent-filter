...
class ConfigHelper
{
    ...
    {
        return config('eloquent-filter.namespaces.filter', 'App\\Filters\\');
    }

    public static function sortNamespace(): string
    {
        return config('eloquent-filter.namespaces.sort', 'App\\Sorts\\');
    }

    public static function requestFilterKey(): string
    {
        return config('eloquent-filter.request_filter_key', 'filter');
    }

    public static function requestSortKey(): string
    {
        return config('eloquent-filter.request_sort_key', 'sort_by');
    }
